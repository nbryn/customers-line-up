...
namespace CLup.Data.Initialiser
{
    public class DataInitialiser
    {
        ...
        public void InitialiseSeed()
        {
            ...
            AddBookings(businessGuids, timeSlotGuids);
            AddEmployees(businessGuids);
        ...
        private void AddBusinesses(List<string> ids)
        {
            ...
            _context.Add(BusinessCreator.Create(ids[0], "Cool", "test@test.com", "Ryttergårdsvej 10", "3520 - Farum",
                                         55.8137419, 12.3935222, 50, "10.00", "16.00", 30,
                                         BusinessType.Supermarket));

            _context.Add(BusinessCreator.Create(ids[1], "Shop", "test@test.com", "Farum Hovedgade 100", "3520 - Farum",
                                         55.809127, 12.3544073, 40, "09.00", "14.00", 20,
                                        BusinessType.Museum));

            _context.Add(BusinessCreator.Create(ids[2], "1337", "test@test.com", "Vermlandsgade 30", "2300 - København S",
        ...
        private void AddBookings(List<string> businessIds, List<string> timeSlotIds)
        {
            ...
            _context.Add(BookingCreator.Create("test@test.com", businessIds[0], timeSlotIds[0]));
            _context.Add(BookingCreator.Create("test@test.com", businessIds[0], timeSlotIds[1]));
            _context.Add(BookingCreator.Create("test@test.com", businessIds[0], timeSlotIds[2]));
        }
        private void AddEmployees(List<string> businessIds)
        {
            ...
            _context.Add(EmployeeCreator.Create(DateTime.Now, businessIds[0], "test@test.com", "cool@cool.com"));
            _context.Add(EmployeeCreator.Create(DateTime.Now, businessIds[1], "h@h.com", "shop@shop.com"));
        }
